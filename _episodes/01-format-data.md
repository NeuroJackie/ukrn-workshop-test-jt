...
exercises: 15
questions:
  - What are some common challenges with formatting data in spreadsheets and how
    can we avoid them?
objectives:
...
![multiple-info example]({% include installedFile.lqd path='/fig/multiple-info.png' %})
...
![single-info example]({% include installedFile.lqd path='/fig/single-info.png' %})
